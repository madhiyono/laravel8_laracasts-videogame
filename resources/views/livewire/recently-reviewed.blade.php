        ...
        <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
            <div class="relative flex-none">
                <a href="{{ route('games.show', $game['slug']) }}">
                    ...
                    @else
                        <img src="https://images.igdb.com/igdb/image/upload/t_cover_big/nocover.png" alt="game cover" class="w-20 lg:w-48 hover:opacity-75 transition ease-in-out duration-150">
                    @endif
                </a>
                @isset($game['rating'])
