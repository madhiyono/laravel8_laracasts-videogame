    ...
    <div class="container mx-auto px-4">
        <div class="game-details pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 xl:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-4 lg:mt-1">{{ $game['name'] }}</h2>
                ...
                <div class="grid grid-cols-2 gap-y-4 md:flex md:flex-wrap md:items-center mt-8">
                    ...
                    @isset($game['websites'])
                        <div class="flex items-center space-x-4 mt-4 sm:mt-0 sm:ml-12">
                            @if ($game['websites']['official'])
                                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href="{{ $game['websites']['official'] }}" class="hover:text-gray-400">
                            ...
                            @endif
                            @if ($game['websites']['instagram'])
                                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href="{{ $game['websites']['instagram'] }}" class="hover:text-gray-400">
                            ...
                            @endif
                            @if ($game['websites']['twitter'])
                                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href="{{ $game['websites']['twitter'] }}" class="hover:text-gray-400">
                            ...
                            @endif
                            @if ($game['websites']['facebook'])
                                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                    <a href="{{ $game['websites']['facebook'] }}" class="hover:text-gray-400">
                ...
                @isset($game['summary'])
                    <p class="mt-8 md:mt-12">{{ $game['summary'] }}</p>
                @endisset
