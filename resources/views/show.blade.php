                    ...
                    <div class="flex items-center space-x-4 mt-4 sm:mt-0 sm:ml-12">
                        @if ($game['official'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['official'] }}" class="hover:text-gray-400">
                        ...
                        @if ($game['instagram'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['instagram'] }}" class="hover:text-gray-400">
                        ...
                        @if ($game['twitter'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['twitter'] }}" class="hover:text-gray-400">
                        ...
                        @if ($game['facebook'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['facebook'] }}" class="hover:text-gray-400">
